...
public class DisplayPanel extends JPanel implements Runnable {
	...
	public void paint(Graphics g) {
		...
		if (highlighted != null) {
			...
			ArrayList<Polygon> pp = new ArrayList<>();

			displayAll(g2d, highlighted, pp, 0);

			/*
			 * Neighbor Display Code below trap = highlighted.getBoundary();
			 * g2d.draw(trap[0].getline()); g2d.draw(trap[1].getline());
			 * g2d.draw(trap[2].getline()); g2d.draw(trap[3].getline());
			 * //System.out.println(trap[0] + " to " + trap[2]); g2d.setStroke(new
			 * BasicStroke((float) 2.0)); g2d.setColor(Color.red); if
			 * (highlighted.getLowerLeftNeighbor() != null) { trap =
			 * highlighted.getLowerLeftNeighbor().getBoundary();
			 * g2d.draw(trap[0].getline()); g2d.draw(trap[1].getline());
			 * g2d.draw(trap[2].getline()); g2d.draw(trap[3].getline()); } if
			 * (highlighted.getLowerRightNeighbor() != null) { trap =
			 * highlighted.getLowerRightNeighbor().getBoundary();
			 * g2d.draw(trap[0].getline()); g2d.draw(trap[1].getline());
			 * g2d.draw(trap[2].getline()); g2d.draw(trap[3].getline()); } if
			 * (highlighted.getUpperLeftNeighbor() != null) { trap =
			 * highlighted.getUpperLeftNeighbor().getBoundary();
			 * g2d.draw(trap[0].getline()); g2d.draw(trap[1].getline());
			 * g2d.draw(trap[2].getline()); g2d.draw(trap[3].getline()); } if
			 * (highlighted.getUpperRightNeighbor() != null) { trap =
			 * highlighted.getUpperRightNeighbor().getBoundary();
			 * g2d.draw(trap[0].getline()); g2d.draw(trap[1].getline());
			 * g2d.draw(trap[2].getline()); g2d.draw(trap[3].getline()); }
			 */
	...
	public void displayAll(Graphics2D g2d, Trapezoid t, ArrayList<Polygon> pp, int i) {
		...
		// i++; //was necessary before I dealt with the fact that Polygon does not have
	...
	/**
	 * Recursively fills the left neighbors of the given trapezoid in the polygon.
	 * (old)
	 *
	 * @param g2d
	 * @param t
	...
	/**
	 * Recursively fills the right neighbors of the given trapezoid in the polygon.
	 * (old)
	 *
	 * @param g2d
	 * @param t
